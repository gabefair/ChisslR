...
The app layout consists of a sidebar that allows selecting options and providing info about the app, a mainPanel that contains tabs for exploratory data analysis (EDA), and a tab for analyzing a selected class. There is another tab that allows epxloration of data that could be misclassified, allowing the user to visualize it and interact with it to provide the correct labels.
...
The app also displays a message while the data is being laoded, extracted and cleaned, making sure the user knows when the app is performing these background tasks.
